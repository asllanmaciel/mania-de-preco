        ...
        return [
            ...
            'etapas' => [
                ...
                [
                    ...
                    'critica' => true,
                    'acao' => 'Configurar ASAAS_API_KEY',
                ],
                [
                    'titulo' => 'Webhook protegido',
                    'descricao' => 'O token do webhook reduz risco de atualização indevida de cobrança.',
                    'concluida' => filled(config('billing.providers.asaas.webhook_token')),
                    'critica' => true,
                    'acao' => 'Configurar ASAAS_WEBHOOK_TOKEN',
                ],
                [
